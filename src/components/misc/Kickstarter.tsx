...
import * as styles from "./Kickstarter.module.scss"
...
export default class Kickstarter extends React.PureComponent<KickstarterProps> {
  public render(): React.ReactNode {
    if (this.props.link == null) {
      return null
    }
    const className = classnames(styles.kickstarter, this.props.className)
        ...
        <Card.Body>
          <Row>
            <Col md={2} className="mb-3">
              <img src={`../../logo/kickstarter.png`} alt="kickstarer" />
            </Col>
            <Col md={10}>
              ...
              <div>
                <OutboundLink
                  ...
                  target="_blank"
                  className={styles.btnKickstarter}
                >
                  Acquistalo qui
                </OutboundLink>
              </div>
