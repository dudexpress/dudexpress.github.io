...
const AdvisorPostList = ({ data, location, pageContext }) => {
...
export default AdvisorPostList

export const AdvisorPostListQuery = graphql`
  query AdvisorPostListQuery($skip: Int!, $limit: Int!, $types: [String]) {
    site {
      siteMetadata {
        title
      }
