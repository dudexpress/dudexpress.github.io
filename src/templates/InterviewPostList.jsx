...
const InterviewPostList = ({ data, location, pageContext }) => {
...
export const InterviewPostListQuery = graphql`
  query InterviewPostListQuery($skip: Int!, $limit: Int!, $types: [String]) {
    site {
      siteMetadata {
        title
      }
