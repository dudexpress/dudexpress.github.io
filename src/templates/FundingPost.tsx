    ...
    <MDXProvider components={shortcodes}>
      <Layout location={location} title={siteTitle}>
        <Helmet>
          ...
          <meta
            name="keywords"
            content={`${post.frontmatter.title}, dudexpress, migiori giochi, nuova uscite, new, kickstarter, backerkit, gamefound, crowdfunding, best of, dudefunding, gioco, gioco da tavolo, recensioni, board game, review`}
          />
...
export const pageQuery = graphql`
  query FundingPostBySlug($id: String!, $readMoreIds: [String]!) {
    site {
      siteMetadata {
        title
      }
...
export interface FundingPostDataProps {
  site: {
...
export interface FundingPostProps {
  data: FundingPostDataProps
  location: Location
}
