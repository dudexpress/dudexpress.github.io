...
<Rules>
  ...
  *rullo di tamburi*…
  ...
  <br />
  Ogni dado, oltre a fornire un risultato numerico, dovrà anche essere
  posizionato in una zona particolare sulla scheda del giocatore determinata dal
  proprio colore.
  <br />
  <ul>
    <li>
  ...
  Oltre a determinare i punteggi finali, ogni zona regalerà ai giocatori dei bonus
  che permetteranno fantasmagoriche combo!
</Rules>
