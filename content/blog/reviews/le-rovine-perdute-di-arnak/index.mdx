...
<Rules>
  ...
  <ul>
    <li>
      <strong>Scavare presso un sito</strong>, inviando uno dei 2 ricercatori e raccogliendo le risorse mostrate dal
      luogo
    </li>
    <li>
      <strong>Scoprire un nuovo sito</strong>, spendendo bussole ma ricavando maggiori punti vittoria e risorse...
      risvegliando anche il guardiano
    </li>
    <li>
      <strong>Sconfiggere un guardiano</strong>, pagando le risorse mostrate dalla tessera e guadagnando 5 punti
      vittoria
    </li>
    <li>
    ...
    <li>
      <strong>Giocare una carta</strong>, calarla dalla vostra mano risolvendone gli effetti
    </li>
    <li>
      <strong>Ricercare</strong>, avanzare lungo il tracciato di ricerca, pagando le risorse necessarie
    </li>
    <li>
