...
<ul>
  <li>
    La <strong>Cava</strong>, la <strong>Foresta</strong>, la{" "}
    ...
    visitare la prigione per consegnare o liberare prigionieri.
  </li>
  <li>
    Il <strong>Mercato Nero</strong> è uno speciale luogo nel quale è possibile
    ...
    luogo che fornisce numerose risorse a un costo elevato sulla lunga durata.
  </li>
  <li>
    La <strong>Sede delle Corporazioni</strong> è il luogo in cui i giocatori
