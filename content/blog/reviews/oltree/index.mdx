...
<Rules>
  ...
  <ol>
    <li>
      Durante la prima fase si tira il dado turno che farà avanzare il segnalino turno su uno dei quattro spazi del
      tracciato; ad ogni spazio corrisponde una carta da dover leggere o piazzare sul tabellone. Gli spazi sono i
      seguenti:&nbsp;
    </li>
    <ul>
      <li>
        <strong>Cronaca</strong>. Si gira pagina e si legge un nuovo capitolo della storia principale, dove saranno
        indicati obiettivi e missioni. Risolverli garantirà un lieto fine, fallire comporterà una sconfitta.
      </li>
      <li>
        <strong>Incombenze</strong>. Si piazza una nuova carta su una delle otto regioni della mappa; se ci sono quattro
        carte incombenza contemporaneamente sulla stessa regione, quest’ultima è dichiarata pericolosa, con conseguente
        perdita di prestigio a fine round.
      </li>
      <li>
        <strong>Problemi</strong>. Si piazza il problema sopra uno dei villaggi delle otto regioni, cosa che impedirà ai
        giocatori di eseguire le azioni ad essi collegate (di solito ottenere risorse).
      </li>
      <li>
    ...
    <li>
      Durante la seconda fase ogni giocatore può svolgere due azioni tra le seguenti: spostarsi, riposare, compiere una
      delle azioni dei villaggi, risolvere una carta problema, risolvere una carta incombenza, costruire o riparare un
      edificio, costruire una torre.
      <br />
    </li>
  </ol>
