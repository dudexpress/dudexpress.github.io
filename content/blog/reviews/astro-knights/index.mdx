...
<Rules>
  ...
  <Link to="/reviews/aeon-s-end/">Aeon's end</Link> in quanto tutto il flusso di gioco
...
<Feedback>
  ...
  <Link to="/reviews/aeon-s-end/">Aeon's end</Link> (sì è una saga con un sacco di
  espansioni) non è mai riuscita a fare: snellire l'esperienza di gioco.
