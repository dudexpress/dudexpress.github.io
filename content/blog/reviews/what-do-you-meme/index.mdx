...
<Setting>
  ...
  <br />
  <strong>Riunisci</strong> i tuoi <strong>amici</strong> dove ti pare, preferibilmente attorno ad un tavolo. Il vostro <strong>
    obiettivo
  </strong> sarà quello di <strong>creare</strong> il <strong>meme</strong> più <strong>divertente</strong> associando le
