...
<Rules>
  ...
  <br />A <strong>turno</strong>, ogni <strong>giocatore</strong> potrà{" "}
  <strong>porre</strong> una <strong>domanda</strong> al fantasma, associando ad
  essa una delle sue <strong>carte</strong> disponibili.
  <br />
  Una volta che un giocatore avrà formulato due ipotesi non potrà continuare a
  giocare.
  <br />
