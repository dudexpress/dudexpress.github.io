...
<Feedback>
  ...
  calare in un peso legger(issim)o dei livelli di **complessità{" "}
  <strong>ed </strong>elaborazione **a cui un pubblico più navigato non può
  rinunciare, anche se solo per una serata di coppia davanti ad una camomilla.
  <br />
</Feedback>
