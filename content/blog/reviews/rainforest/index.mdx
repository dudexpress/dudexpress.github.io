...
<img src="./game1.jpg?t=1" alt="Rainforest" />
...
<img src="./game2.jpg?t=1" alt="Rainforest" />

<Feedback>
  Con un double drafting in qualche modo simile a quello di Cascadia, Rainforest
  risulta un gioco molto semplice e piacevole, pur portando un certo grado di
  novità nel genere e non risultando ridondante o "già visto". L’ambientazione
  non traspare in modo evidente, rendendo il gioco leggermente più astratto di
  quello che ci si sarebbe aspettati, ma le meravigliose illustrazioni e i
  componenti colorati aiutano l’immersione.
  <br />
...
<img src="./game3.jpg?t=1" alt="Rainforest" />
