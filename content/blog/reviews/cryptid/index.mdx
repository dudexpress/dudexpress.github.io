...
<Rules>
  ...
  <ul>
    <li>
      <strong>Interrogare:</strong> si sceglie un esagono privo di cubi e vi si piazza la pedina nera chiedendo a uno
    ...
    <li>
      <strong>Esplorare:</strong> questa azione può potenzialmente portare alla conclusione della partita;l, poiché un
      ...
      posizionano dischi, la tana è stata scoperta e il giocatore di turno vincerà la partita.
    </li>
  </ul>
</Rules>
